...
const BOARD_TEMPLATE = {
    rows: 7,
    cols: 17,
    // Todo espacios; las ecuaciones se dibujan a partir de "equations"
    baseGrid: Array.from({ length: 7 }, () => Array(17).fill(" ")),
    // Cada ecuación son 5 celdas: [A, op, B, =, R]
    equations: [
        // Fila 1 (índice 1)
        { cells: [[1, 0], [1, 1], [1, 2], [1, 3], [1, 4]] },   // izquierda
        { cells: [[1, 8], [1, 9], [1,10], [1,11], [1,12]] },   // derecha

        // Fila 3 (índice 3)
        { cells: [[3, 0], [3, 1], [3, 2], [3, 3], [3, 4]] },   // izquierda
        { cells: [[3, 8], [3, 9], [3,10], [3,11], [3,12]] },   // derecha

        // Fila 5 (índice 5)
        { cells: [[5, 0], [5, 1], [5, 2], [5, 3], [5, 4]] },   // izquierda
        { cells: [[5, 8], [5, 9], [5,10], [5,11], [5,12]] }    // derecha
    ]
};
...
const soundWin      = new Audio("sounds/victoria.mp3");
